...
import { useFollowCam } from "@/utils";
...
export default function Character() {
  ...
  useFrame((state, delta) => {
     ...
     */
    if (!characterModelRef.current || !characterRef.current) return;
